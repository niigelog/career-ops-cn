...
// Display labels live in the i18n catalog (t.seniority[bucket]) — this module
// stays pure derivation so it can be imported by server and client alike.
...
// The 24h window reads as hours, the rest as days — see FacetChips for the
// localized label (t.inbox.windowHours / windowDays).
