    ...
    <div className="mx-auto max-w-none px-6 py-8">
      ...
      <div className="mt-6">
        {mode === "cli" && (
          <div>
            ...
            <p className="mb-3 text-xs text-faint">{t.config.cliSub}</p>
            {clis === null ? (
              ...
              <div className="rounded-xl border border-dashed border-border bg-surface/30 p-4 text-sm text-muted">
                {t.config.noToolLead} <span className="text-foreground">OpenCode</span> {t.config.noToolMid}{" "}
              ...
              <div className="space-y-2">
                  ...
                  return (
                    ...
                    >
                      ...
                      {c.installed ? (
                        ...
                        >
                          {t.config.install} <ExternalLink className="size-3" />
                        </a>
                      )}
                    </div>
                  );
                ...
                {installed.length === 0 && (
                  <p className="rounded-xl border border-dashed border-border bg-surface/30 p-4 text-xs text-muted">
                    {t.config.noCliOnPath}
                  </p>
                )}
                <p className="mt-2 text-[11px] leading-relaxed text-faint">
                  {t.config.bestOnLead} <span className="text-muted">Claude Code</span> {t.config.bestOnTail}
                </p>
              </div>
            )}
          </div>
        ...
        {mode === "key" && (
          <div className="space-y-5">
            ...
            <div>
              ...
              <p className="mb-2 text-xs text-faint">{t.config.keyIntro}</p>
              <input
                type="password"
                value={apiKey}
      ...
      <div className="mt-8 flex items-center gap-3">
        ...
        >
          ...
          {saved ? t.common.saved : t.config.saveConfig}
        </button>
        <span className="text-xs text-faint">{t.config.roadmapNote}</span>
      </div>
    </div>
  );
}
