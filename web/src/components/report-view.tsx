      ...
      <header className="mt-5">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2.5">
          ...
          {(() => {
            ...
            return n >= 4.0 ? <Badge tone="good">{t.report.recommended}</Badge> : <Badge tone="muted">{t.report.belowApplyLine}</Badge>;
          })()}
              ...
              <div className="mt-8">
                ...
                {verdict && (
                  <div className="rounded-2xl border border-brand/25 bg-brand-soft/50 px-5 py-4">
                    <p className="mb-1 font-mono text-[11px] uppercase tracking-[0.16em] text-brand/80">{t.report.verdict}</p>
